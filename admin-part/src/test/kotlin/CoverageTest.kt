...
class CoverageTest {
    ...
    fun `count - operation minus`() {
        assertEquals(0L to 0L, zeroCount minuss zeroCount)
        assertEquals(1L to 2L, Count(1, 2) minuss zeroCount)
        assertEquals(1L to 2L, Count(1, 2) minuss Count(2, 0))
        assertEquals(0L to 3L, Count(1, 3) minuss Count(1, 3))
        assertEquals(1L to 6L, Count(1, 2) minuss Count(1, 3))
        assertEquals(2L to 6L, Count(4, 6) minuss Count(1, 3))
        assertEquals(3L to 6L, Count(1, 2) minuss Count(0, 3))
    }
