...
}.toCounter(bundleName = bundleName, preparedData = preparedData)
...
}.toCounter(false, bundleName, preparedData)
    ...
    packages.forEach { p ->
        ...
        if (classesWithMethods.any()) {
            ...
            classesWithMethods.map { c ->
                ...
                val classCounterKey =
                    ClassCounter(path = packageName, name = classname(c.name), fullName = classFullName)
