...
val asd = WeakHashMap<MethodCounter, MethodCounter>()

fun gets(methodCounter:MethodCounter): MethodCounter {
    var get = asd[methodCounter]
    if(get == null){
        asd[methodCounter] = methodCounter
        get = methodCounter
    }
    return get
}
