...
interface TestsAssociatedWithBuild {
    ...
    fun getTestsAssociatedWithMethods(
        buildVersion: String,
...
class MutableMapTestsAssociatedWithBuild : TestsAssociatedWithBuild {
    ...
    override fun getTestsAssociatedWithMethods(
        buildVersion: String,
        agentState: AgentState,
        javaMethods: List<JavaMethod>
    ...
    private fun previousBuildVersion(buildVersion: String, agentState: AgentState): String {
